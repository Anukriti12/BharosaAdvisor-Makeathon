...
public class AddTransactionsAdapter extends RecyclerView.Adapter<AddTransactionsAdapter.ViewHolder>
{
    private Context ctx;
    ...
    public AddTransactionsAdapter(Context _ctx,
            ...
            public void onClick(View view)
            {
                ...
                try
                {
                    RequestHelper request = new RequestHelper(activity,
                            SERVICE_URL + "apiwealthsimple/updateaddtransactiondata",
                            true,
                            true);
    ...
    @NonNull
    @Override
    public AddTransactionsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        View view = LayoutInflater.from(ctx).inflate(R.layout.item_dialog_transaction, parent, false);
        return new AddTransactionsAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AddTransactionsAdapter.ViewHolder holder,
                                 int position)
    {
